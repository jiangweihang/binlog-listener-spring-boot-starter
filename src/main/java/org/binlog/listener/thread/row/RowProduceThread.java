 ...
 * @version: 1.0.0
 */
public class RowProduceThread implements Runnable {
    ...
    public RowProduceThread(ConcurrentHashMap<String, Event> taskMap, Lock lock, Condition notEmpty, Event event) {
